...
class MessageHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create message_history' do
    assert_difference('MessageHistory.count') do
      post message_histories_url,
           params: { message_history: { date_sent: @message_history.date_sent, message_id: @message_history.message_id,
                                        student_id: @message_history.student_id } }
    end
